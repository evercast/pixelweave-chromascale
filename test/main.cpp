...
int main()
{
    ...
    if (result == PixelWeave::Result::Success) {
        ...
        PixelWeave::ProtoVideoFrame srcFrame{fakeSrcBuffer.data(), 1280, 720, PixelWeave::PixelFormat::Interleaved8BitUYVY};

        std::vector<uint8_t> fakeDstBuffer(1280 * 720 * 4, 0);
        PixelWeave::ProtoVideoFrame dstFrame{fakeSrcBuffer.data(), 1280, 720, PixelWeave::PixelFormat::Planar8Bit422};
